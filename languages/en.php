...
%s",
	...
	'blog_tools:view:excerpt:title' => 'Summary',			
	...
	'blog_tools:settings:size:tiny' => "Tiny (16px)",
	'blog_tools:settings:size:small' => "Small (40px)",
	'blog_tools:settings:size:medium' => "Medium (100px)",
	'blog_tools:settings:size:large' => "Large (200px)",
	'blog_tools:settings:size:extralarge' => "Extra large (450px)",
	'blog_tools:settings:size:master' => "Master (550px)",
	
	'blog_tools:settings:full:show_excerpt' => 'Show excerpt',
