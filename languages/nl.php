...
$language = array(
  ...
  'blog_tools:view:excerpt:title' => 'In het kort',
  ...
  'blog_tools:settings:full:show_excerpt' => 'Toon uittreksel',
...
%s',
  ...
  'blog_tools:settings:size:tiny' => 'Erg klein (16px)',
  'blog_tools:settings:size:small' => 'Klein (40px)',
  'blog_tools:settings:size:medium' => 'Medium (100px)',
  'blog_tools:settings:size:large' => 'Groot (200px)',
  'blog_tools:settings:size:extralarge' => 'Extra groot (450px)',
